...
extern crypto_scalarmult_curve13318_ref12_fe12_mul_karatsuba, crypto_scalarmult_curve13318_ref12_fe12_square_karatsuba, crypto_scalarmult_curve13318_ref12_fe12_squeeze

section .rodata

_bench1_name: db `ge_double\0`
_bench2_name: db `ge_double_gcc\0`
_bench3_name: db `ge_double_clang\0`

align 8, db 0
_bench_fns_arr:
dq ge_double_asm, ge_double_gcc, ge_double_clang
