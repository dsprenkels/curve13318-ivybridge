...
ge_add_asm:
    ...
    %xdefine x1          rel scratch_space + 36*8
    %xdefine y1          rel scratch_space + 36*8 + 12*8
    %xdefine z1          rel scratch_space + 36*8 + 24*8
    %xdefine x2          rel scratch_space + 72*8
    %xdefine y2          rel scratch_space + 72*8 + 12*8
    %xdefine z2          rel scratch_space + 72*8 + 24*8
    %xdefine t0          rsp
    %xdefine t1          rsp + 1*384
    %xdefine t2          rsp + 2*384
    %xdefine t3          rsp + 3*384
    %xdefine t4          rsp + 4*384
    ; FIXME t5 is not used in this function
    %xdefine t5          rsp + 5*384
    %xdefine scratch     rsp + 6*384
...
align 32, db 0
.const_3_3_3_3: dq 3.0,3.0,3.0,3.0
align 8, db 0
